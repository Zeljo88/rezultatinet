...
<body class="bg-[#0f0f0f] text-white font-sans min-h-full overflow-x-hidden">
    ...
    {{-- TOP NAV --}}
    <nav class="bg-[#1a1a1a] border-b border-[#2a2a2a] sticky top-0 z-50 max-w-full overflow-hidden">
...
<div class="mb-4">
    ...
    <script async defer crossorigin="anonymous"
      src="https://connect.facebook.net/bs_BA/sdk.js#xfbml=1&version=v19.0">
    </script>
</body>
</html>
