...
<head>
    ...
    <title>@yield('title', 'Rezultati uÅ¾ivo') â€” rezultati.net</title>
...
<body class="bg-[#0f0f0f] text-white font-sans min-h-full">
        ...
        <div class="max-w-5xl mx-auto px-4">
            <div class="flex items-center justify-between h-14">
                ...
                <div class="flex items-center gap-1">
                    <a href="/" class="px-3 py-1.5 rounded text-sm font-semibold {{ request()->is('/') ? 'bg-[#CCFF00] text-black' : 'text-gray-400 hover:text-white' }} transition">âš½ Fudbal</a>
                    <a href="/kosarka" class="px-3 py-1.5 rounded text-sm font-semibold {{ request()->is('kosarka*') ? 'bg-[#CCFF00] text-black' : 'text-gray-400 hover:text-white' }} transition">í¿€ Kosarka</a>
                    <a href="/tenis" class="px-3 py-1.5 rounded text-sm font-semibold {{ request()->is('tenis*') ? 'bg-[#CCFF00] text-black' : 'text-gray-400 hover:text-white' }} transition">í¾¾ Tenis</a>
                </div>
    ...
    <footer class="border-t border-[#2a2a2a] mt-12 py-6 text-center text-gray-500 text-sm">
        <p>Â© {{ date('Y') }} rezultati.net â€” Rezultati uzivo</p>
